# Uses $EPICS_EXTENSIONS/bin/Linux/et_tclsh

set machine "sdsscommish.apo.nmsu.edu"
set port 4812
...
if {$arg == "start" || $arg == "restart"} {
    ...
    cd /local/ups/prd/tpm/production/ChanArch/config 
    ...
    exec /local/ups/prd/tpm/production/ChanArch/bin/startEngine $newdir &
}
